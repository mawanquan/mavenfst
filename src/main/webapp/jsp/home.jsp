			...
			<div class="body1">
				<div class="row">
					<div class="col-md-9 b1">
						...
						<!--***********************************************************************-->
						<div class="card-tittle"><span class="glyphicon glyphicon-list"></span>&nbsp;招标大厅
						</div>

						<div class="l1">
							<ul class="nav nav-tabs  ul-1" role="tablist">
								<li role="presentation" class="active">
									<a href="#1" aria-controls="1" role="tab" data-toggle="tab">正在招标</a>
								</li>
								<li role="presentation">
									<a href="#2" aria-controls="2" role="tab" data-toggle="tab">即将开标</a>
								</li>
								<li role="presentation">
									<a href="#3" aria-controls="3" role="tab" data-toggle="tab">正在候选人公示</a>
								</li>

								<li style="padding-right: 10px; border: none;float: right;background-color: transparent;position: relative;top: -1px;">
									<a href="#settings" style="font-size: 12px; color: #333;padding-top: 15px;border: none;">更多</a>
								</li>
							</ul>
						...
						<div class="l1">
							<ul class="nav nav-tabs  ul-1 ul-1-1" role="tablist">
								...
								<li role="presentation" class="active">
									<a href="#11" aria-controls="11" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>&nbsp;&nbsp;采购公告</a>
								</li>
								<li role="presentation">
									<a href="#22" aria-controls="22" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-globe" aria-hidden="true"></span>&nbsp;&nbsp;资格预审</a>
								</li>
								<li role="presentation">
									<a href="#33" aria-controls="33" role="tab" data-toggle="tab"><span class=" glyphicon glyphicon-indent-left " aria-hidden="true"></span>&nbsp;&nbsp;候选人</a>
								</li>
								<li role="presentation">
									<a href="#44" aria-controls="44" role="tab" data-toggle="tab"><span class=" glyphicon glyphicon-indent-left " aria-hidden="true"></span>&nbsp;&nbsp;中选结果</a>
								</li>
								<li role="presentation">
									<a href="#55" aria-controls="55" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span>&nbsp;&nbsp;单一来源采购信息</a>
								</li>
								<li role="presentation">
									<a href="#66" aria-controls="66" role="tab" data-toggle="tab"><span class="glyphicon glyphicon-comment" aria-hidden="true"></span>&nbsp;&nbsp;供应商信息收集</a>
								</li>
							</ul>
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane active" id="11">
									<div class="l1">
										<ul class="nav nav-tabs ul-1 ul-1-2" role="tablist">
											<li role="presentation" class="active">
												<a href="#j1" aria-controls="j1" role="tab" data-toggle="tab">集团公司</a>
											</li>
											<li role="presentation">
												<a href="#s1" aria-controls="s1" role="tab" data-toggle="tab">省公司</a>
											</li>
											<li style="padding-right: 10px;background-color: transparent;position: relative;top: -1px; border: none;float: right;">
												<a href="#settings" style="font-size: 12px; color: #333;padding-top: 15px;">更多</a>
											</li>
										</ul>
										<div class="tab-content tab-1">
								...
								<div role="tabpanel" class="tab-pane" id="22">
									<div class="l1">
										<ul class="nav nav-tabs ul-1 ul-1-2" role="tablist">
											<li role="presentation" class="active">
												<a href="#j2" aria-controls="j2" role="tab" data-toggle="tab">集团公司</a>
											</li>
											<li role="presentation">
												<a href="#s2" aria-controls="s2" role="tab" data-toggle="tab">省公司</a>
											</li>
											<li style="padding-right: 10px; border: none;float: right;background-color: transparent;position: relative;top: -1px;">
												<a href="#settings" style="font-size: 12px; color: #333;padding-top: 15px;">更多</a>
											</li>
								...
								<div role="tabpanel" class="tab-pane" id="33">
									<div class="l1">
										<ul class="nav nav-tabs ul-1 ul-1-2" role="tablist">
											<li role="presentation" class="active">
												<a href="#j3" aria-controls="j3" role="tab" data-toggle="tab">集团公司</a>
											</li>
											<li role="presentation">
												<a href="#s3" aria-controls="s3" role="tab" data-toggle="tab">省公司</a>
											</li>
											<li style="padding-right: 10px; border: none;float: right;background-color: transparent;position: relative;top: -1px;">
												<a href="#settings" style="font-size: 12px; color: #333;padding-top: 15px;">更多</a>
											</li>
								...
								<div role="tabpanel" class="tab-pane" id="44">
									<div class="l1">
										<ul class="nav nav-tabs ul-1 ul-1-2" role="tablist">
											<li role="presentation" class="active">
												<a href="#j4" aria-controls="j4" role="tab" data-toggle="tab">集团公司</a>
											</li>
											<li role="presentation">
												<a href="#s4" aria-controls="s4" role="tab" data-toggle="tab">省公司</a>
											</li>
											<li style="padding-right: 10px; border: none;float: right;background-color: transparent;position: relative;top: -1px;">
												<a href="#settings" style="font-size: 12px; color: #333;padding-top: 15px;">更多</a>
											</li>
								...
								<div role="tabpanel" class="tab-pane" id="55">
									<div class="l1">
										<ul class="nav nav-tabs ul-1 ul-1-2" role="tablist">
											<li role="presentation" class="active">
												<a href="#j5" aria-controls="j5" role="tab" data-toggle="tab">集团公司</a>
											</li>
											<li role="presentation">
												<a href="#s5" aria-controls="s5" role="tab" data-toggle="tab">省公司</a>
											</li>
											<li style="padding-right: 10px; border: none;float: right;background-color: transparent;position: relative;top: -1px;">
												<a href="#settings" style="font-size: 12px; color: #333;padding-top: 15px;">更多</a>
											</li>
					...
					<div class="col-md-3 b2">
						...
						<div class="r2 pull-left" style="">
							<ul class="r2-1">
								...
								<li>
									<p class="navbar-text">
										...
										<a href="denglu.html">代理登录</a>
										<a href="denglu.html">专家登录</a>
									</p>
								</li>
							</ul>
							<ul class="r2-1 r2-1-1" style="">
								<li>
									<p class="navbar-text">
										<img src="images/img/h4.png" />
										<img src="images/img/h5.png" />
									</p>
								</li>
								<li>
									<p class="navbar-text">
										<a href="${cxt}/admin/gologinview">员工登录</a>
										<a href="denglu.html">检测机构登录</a>
									</p>
								</li>
							</ul>
							<div class=" pull-right">
								<p style="position: relative;top: -95px;">
									<span class="small text-muted">还没有供应商账号，去</span>
									<a href="zhuce.html">【注 册】</a><br /> <span class="small text-muted">第三方检测机构</span>
									<a href="zhuce.html">【注 册】</a>
								</p>
							</div>
