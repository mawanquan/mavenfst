					...
					<div class="container-fluid ">
						...
						<div class="collapse navbar-collapse"
							...
							<ul class="nav navbar-nav  top-bot-1 ">
								...
								<li  class="active"><a href="${cxt}/jsp/jiapage/caigougonggao.jsp">招标采购公告</a>
								</li>
					...
					<div class="col-xs-3 m1">
						<ul class="nav nav-pills nav-stacked m1-1" role="tablist ">
							<li role="presentation" class="active">
								<a href="#home" aria-controls="home" role="tab" data-toggle="tab"><img src="images/img/m11.png" style="" />&nbsp;采购公告</a>
							</li>
							<li role="presentation">
								<a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><img src="images/img/m12.png" style="" />&nbsp;资格预审公告</a>
							</li>
							<li role="presentation">
								<a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><img src="images/img/m13.png" style="" />&nbsp;候选人公告</a>
							</li>
							<li role="presentation">
								<a href="#settings1" aria-controls="settings1" role="tab" data-toggle="tab"><img src="images/img/m14.png" style="" />&nbsp;中选结果公告</a>
							</li>
							<li role="presentation">
								<a href="#settings2" aria-controls="settings2" role="tab" data-toggle="tab"><img src="images/img/m15.png" style="" />&nbsp;单一来源采购信息公告</a>
							</li>
							<li role="presentation">
								<a href="#settings3" aria-controls="settings3" role="tab" data-toggle="tab"><img src="images/img/m16.png" style="" />&nbsp;供应商信息收集公告</a>
							</li>
						</ul>
					</div>
