...
<script type="text/javascript">
	...
	function goToPage(page) {
		...
		window.location.href = "${cxt}/${path}/" + page + "?title=" + title;
	}
</script>
...
<body>
	...
	<form method="get" action="${cxt}/bids/search" name="fmName" id="fmName">
				...
				<tbody>
					...
					<c:forEach items="${list}" var="v">
						...
						<tr style="width:100%;" class="_data_tr_flag active">
							<td style="width:75%" align="left"><a href="/mavenfst/bids/show?id=${v.id}">${v.title}</a></td>
